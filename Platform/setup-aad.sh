...
WEBSITE_CLIENT_SECRET=$(az ad app credential reset --id $AAD_WEBSITE_APPLICATION_ID --credential-description 'AADClientSecret' --append --query "passwords[0].value" -o tsv)
