...
WEBSITE_CLIENT_SECRET=$(az ad app credential reset --id $AAD_WEBSITE_APPLICATION_ID --credential-description 'AAD Client Secret created by CI/CD' --append --query "passwords[0].value" -o tsv)
